// https://github.com/AvaloniaUI/Avalonia.Labs/tree/main/src/Avalonia.Labs.Panels/Flex.cs
...
public static class Flex
{
    ...
    /// </summary>
    public readonly static AttachedProperty<AlignItems?> AlignSelfProperty =
    ...
    /// </summary>
    public readonly static AttachedProperty<int> OrderProperty =
    ...
    /// </summary>
    public readonly static AttachedProperty<FlexBasis> BasisProperty =
    ...
    /// </summary>
    public readonly static AttachedProperty<double> ShrinkProperty =
    ...
    ///     along the main-axis in a flex layout.
    /// </summary>
    public readonly static AttachedProperty<double> GrowProperty =
        AvaloniaProperty.RegisterAttached<Layoutable, double>("Grow", typeof(Flex), validate: v => v >= 0.0);

    internal readonly static AttachedProperty<double> BaseLengthProperty =
        AvaloniaProperty.RegisterAttached<Layoutable, double>("BaseLength", typeof(Flex));

    internal readonly static AttachedProperty<double> CurrentLengthProperty =
        AvaloniaProperty.RegisterAttached<Layoutable, double>("CurrentLength", typeof(Flex));
